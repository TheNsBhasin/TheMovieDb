...
import in.codingninjas.themoviedb.data.FavourateBody;
...
public interface TheMovieDbService {
    ...
    Call<Void> addFavourate(@Query("api_key") String api_key, @Query("session_id") String session_id , @Body Object body);

    @GET("account/{account_id}/favorite/movies")
    Call<DiscoverAndSearchResponse<Movie>> getFavourateMovies(@Query("api_key") String api_key, @Query("session_id") String session_id);
}